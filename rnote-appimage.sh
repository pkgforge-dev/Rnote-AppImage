...
export PATH_MAPPING='/usr/share/locale:${SHARUN_DIR}/share/locale' # GTK applications are usually hardcoded to look into /usr/share, especially noticeable in non-working locale
